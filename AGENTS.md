...
- Current Backend release: `v5.16.5`; Mini App release: `v5.16.0`. Admin copy is functional and concise, while the Overview uses an optimized HelpDesk illustration with accessible motion. Cloud AI reliability still retries malformed structured output and treats a staff-selected model as the preferred first provider with cloud failover before Rules/Playbook.
