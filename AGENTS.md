...
- Current Backend release: `v5.16.3`; Mini App release: `v5.16.0`. The live operations, Playbook and AI Control Plane refresh extends the approved v5.14.1 Warm Industrial design.
