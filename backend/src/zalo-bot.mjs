...
async function processTextMessage(event, callbacks) {
  ...
  if (!event.text) {
    await sendZaloBotMessage(event.chatId, "Bot IT HelpDesk v5.18.6 hiện nhận mô tả bằng văn bản. Vui lòng gửi nội dung lỗi để tôi hỗ trợ.", callbacks.fetchImpl);
