...
test("v5.17.1 Mini App deploy gate accepts the current ready v5.18.3 Backend", async () => {
  const [backendManifestText, miniAppManifestText, workflow, releaseNote, checklist, botRelease, webhookRelease, mobileRelease, accountMenuRelease] = await Promise.all([
  ...
  assert.equal(backendManifest.version, "5.18.3");
